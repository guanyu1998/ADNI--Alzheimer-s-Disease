...
class ResNet(nn.Module):
    def __init__(self,block,block_num,num_class=2,this_channel=16,include_top = True,):
        ...
        self.ca1 = ChannelAttention(2048)#2048为最后的通道数
...
model_weight_path = r'D:/Model/resnet50-pre.pth'
#model_weight_path = r'/home/gy/D/Model/resnet50-pre.pth'
...
for k_fold in range(k):
    ...
    for epoch in range(ep_all):
        ...
        if float(correct / total) > max_acc:  # correct/total为此次准确率，当此次准确率大于最大准确率的时候保存模型，并且将当前acc赋值给max_loss
            #torch.save(net.state_dict(), f=r'/home/gy/D/Model/res50/k-fold/silce-32/res50-32-'+str(k_fold)+'.pth', _use_new_zipfile_serialization=False)
